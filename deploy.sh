...
ssh -o StrictHostKeyChecking=no ec2-user@${MACHINE} "cd /home/ec2-user/ && docker pull orendin8/devops_project/dockerfile1:latest && docker-compose up --no-build -d && sleep 30"
if [ "$MACHINE" == "test" ];
 then
